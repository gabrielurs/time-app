...
const Home = () => {
    ...
    const determineWeather = (weather) => {
        ...
        generalWeatherTmp[1] = conditionalWeather(weather, daysTmp[1], null).generalWeather;
        generalWeatherTmp[2] = conditionalWeather(weather, daysTmp[2], null).generalWeather;
